    ...
    <div class="col-md-9 col-12">
        <div class="col-md-12 p-0 m-0">
                    ...
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Oportunidades de venta</a></li>
                        <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Historial</a></li>
